<?php 
    ...
    function creaTarea($conexion) {
        ...
        if ($opc==="1"){
            ...
            ('$id_usuario', '$id_semestre', '$id_materia', '$nombre_tarea', CURDATE(), CURTIME(), '$prioridad', '$observacion', 0, '$id_compartir')";
        ...
        //Crea la tarea sin compartir
            ...
            $sql = "INSERT INTO tarea (id_usuario, id_semestre, id_materia, nombre_tarea, fecha_inicio, hora_inicio, prioridad, observacion, completada, id_compartir) 
                    VALUES ('$id_usuario', '$id_semestre', '$id_materia', '$nombre_tarea', CURDATE(), CURTIME(), '$prioridad', '$observacion',0, 0)";
